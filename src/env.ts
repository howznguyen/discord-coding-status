...
const PROCESS_IDLE_GRACE_OVERRIDE_MS = Number(
  envValue('DISCORD_CODING_STATUS_PROCESS_IDLE_GRACE_MS', String(5 * 60_000))
);
export const PROCESS_IDLE_GRACE_MS = Number.isFinite(PROCESS_IDLE_GRACE_OVERRIDE_MS)
  ? Math.max(0, PROCESS_IDLE_GRACE_OVERRIDE_MS)
  : 5 * 60_000;

const PROCESS_ACTIVE_CPU_OVERRIDE_MS = Number(
  envValue('DISCORD_CODING_STATUS_PROCESS_ACTIVE_CPU_MS', '50')
);
export const PROCESS_ACTIVE_CPU_MS = Number.isFinite(PROCESS_ACTIVE_CPU_OVERRIDE_MS)
  ? Math.max(0, PROCESS_ACTIVE_CPU_OVERRIDE_MS)
  : 50;
